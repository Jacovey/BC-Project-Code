...
const uint8_t VswitchPINS[numOfChans+6] =   {5,   7,  9,  10, 12, 14, 16,   18, 20, 22,     25, 26,  29,  31,     35,  33};
const uint8_t PswitchPINS[numOfChans+6] =   {4,   6,  8,  11, 13, 15, 17,   19, 21, 23,     24, 27,  28,  30,     34,  32};
